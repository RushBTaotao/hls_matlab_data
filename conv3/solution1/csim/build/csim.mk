...
HLS_SOURCES = ../../../conv3_tb.cpp ../../../conv3_test.cpp
...
$(ObjDir)/conv3_test.o: ../../../conv3_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../conv3_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/conv3_test.d
